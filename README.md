# git-get [![Build Status](https://travis-ci.com/ajdruff/git-get.svg?branch=master)](https://travis-ci.com/ajdruff/git-get)[![codecov](https://codecov.io/gh/ajdruff/git-get/branch/master/graph/badge.svg)](https://codecov.io/gh/ajdruff/git-get)
